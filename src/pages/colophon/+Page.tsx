...
export default function Page() {
  return (
    <div className="w-full max-w-5xl mx-auto md:px-0 px-4">
      ...
      <div className="hidden md:flex sticky top-[calc(100dvh-4.5rem)] border border-black/10 z-20 mx-auto -mb-16 w-auto max-w-xs rounded-[10px] bg-surface-inverted shadow-xl md:max-w-[calc(100%-27rem)] md:justify-self-end md:flex-col">
